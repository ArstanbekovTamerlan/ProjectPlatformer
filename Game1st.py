...
class DoodleJump:
    def __init__(self):
        ...
        self.green = pygame.image.load("assets/plitka.png").convert_alpha()
        pygame.font.init()
        self.score = 0
        self.font = pygame.font.SysFont("Arial", 25)
        self.blue = pygame.image.load("assets/cloud.png").convert_alpha()
        self.red = pygame.image.load("assets/plitkalava.png").convert_alpha()
        self.red_1 = pygame.image.load("assets/plitkalavabroken.png").convert_alpha()
        self.playerRight = pygame.image.load("assets/idle.png").convert_alpha()
        self.playerRight_1 = pygame.image.load("assets/idlejump.png").convert_alpha()
        self.playerLeft = pygame.image.load("assets/leftidle.png").convert_alpha()
        self.playerLeft_1 = pygame.image.load("assets/leftidlejump.png").convert_alpha()
        self.spring = pygame.image.load("assets/eye.png").convert_alpha()
        self.spring_1 = pygame.image.load("assets/eyekinul.png").convert_alpha()
        self.direction = 0
        self.playerx = 400
        self.playery = 400
